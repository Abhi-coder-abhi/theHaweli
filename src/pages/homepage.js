    ...
    return (
        <div style={{ marginBottom: '50px' }}>
            <div style={{ position: 'relative', }}>
                ...
                <div style={{ position: 'absolute', top: `${78 / 16}vw`,marginLeft:"0.8vw"}}>
                    <img style={{ width: "11vw", height: "8vw" }} src={logo} alt="My Image" />
                </div>
            ...
            <div style={{ marginRight: '5vw', marginLeft: '5vw ' }}>
                ...
                <div style={{ display: 'flex', marginBottom: `${50 / 16}vw`, marginLeft: "5.5vw" }}>
                    ...
                    <div style={{ marginLeft: `${550 / 16}vw` }}>
                        ...
                        <PhoneIcon style={{ fontSize: '1vw', marginTop: `${10 / 16}vw` }} />+91971890521
